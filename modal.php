		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="app-modal-header modal-header">
					...
					<h3>Crear Producto <span class="glyphicon glyphicon-inbox"></span></h3>
				</div>
				<div class="modal-body">
					...
					<div class="app-modal-footer modal-footer">
						...
						<button class="btn btn-danger" data-dismiss="modal">Salir <span class="glyphicon glyphicon-off"></span></button>
					</div>
				</form>
			</div>
		</div>
